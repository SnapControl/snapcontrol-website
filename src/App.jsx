          ...
          <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[1fr_1fr] lg:items-center">
              ...
              <div className="mt-8 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-blue-100 bg-blue-50 p-5 sm:col-span-2">
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="rounded-xl bg-white px-4 py-4 text-center font-semibold text-slate-900 shadow-sm">✓ Fully Insured</div>
                    <div className="rounded-xl bg-white px-4 py-4 text-center font-semibold text-slate-900 shadow-sm">✓ DBS Checked</div>
                    <div className="rounded-xl bg-white px-4 py-4 text-center font-semibold text-slate-900 shadow-sm">✓ BPCA Trained</div>
                    <div className="rounded-xl bg-white px-4 py-4 text-center font-semibold text-slate-900 shadow-sm">✓ Licensed Technicians</div>
                  </div>
                </div>
            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-slate-950 to-blue-800 p-10 text-white shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="mb-8 inline-flex h-20 w-20 items-center justify-center rounded-3xl bg-white text-5xl shadow-xl">🛡️</div>

                <h3 className="text-3xl font-black leading-tight">Reliable protection for homes and businesses.</h3>

                <div className="mt-8 space-y-5 text-lg text-slate-100">
                  <div className="flex items-center gap-4"><span className="text-2xl">✓</span><p>Qualified and experienced technicians</p></div>
                  <div className="flex items-center gap-4"><span className="text-2xl">✓</span><p>Safe and effective treatment methods</p></div>
                  <div className="flex items-center gap-4"><span className="text-2xl">✓</span><p>Commercial and residential pest solutions</p></div>
                  <div className="flex items-center gap-4"><span className="text-2xl">✓</span><p>Routine inspections and prevention plans</p></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="guides" className="bg-blue-50/60 px-6 py-16">
          <div className="mx-auto max-w-5xl">
            <div className="mb-12 text-center">
              ...
              <h2 className="mt-4 text-5xl font-black text-slate-950">Learn how to spot and prevent common pests.</h2>
              <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-slate-700">Helpful advice and practical prevention tips for homes, businesses, and commercial properties.</p>
            </div>

            <div className="space-y-5">
              {[
                ["🐀 Rodent Guide", "Rats and mice are commonly attracted to food sources, warmth, and hidden shelter areas. Common signs include scratching noises, droppings, damaged packaging, and strong odours.", "To help prevent infestations, seal entry points, remove food waste promptly, and schedule regular inspections for your property."],
                ["🪳 Cockroach Guide", "Cockroaches thrive in warm and damp environments such as kitchens, storage rooms, and commercial food areas. They can spread bacteria and contaminate surfaces.", "Keeping areas clean, reducing moisture, and professional treatments are the most effective ways to prevent cockroach infestations."],
                ["🐜 Ant Prevention", "Ants are usually attracted to sweet foods, crumbs, and moisture around kitchens and gardens. Small colonies can quickly become larger infestations if left untreated.", "Wiping surfaces regularly, storing food correctly, and blocking entry points can help reduce ant activity around your property."],
                ["🕊️ Bird Prevention", "Birds such as pigeons and gulls can create nesting problems, property damage, noise issues, and health risks for homes and businesses.", "Professional bird proofing solutions including spikes, netting, and deterrent systems can help protect roofs, signage, solar panels, and commercial buildings."],
                ["🪰 Fly Prevention", "Flies are commonly attracted to food waste, drains, bins, and warm environments. They can quickly become a nuisance in homes, restaurants, kitchens, and commercial properties.", "Regular cleaning, proper waste management, fly screens, and professional treatments can help reduce fly activity and prevent infestations."]
              ].map(([title, first, second]) => (
                <details key={title} className="rounded-3xl border border-blue-100 bg-white p-8 shadow-sm">
                  <summary className="cursor-pointer list-none text-2xl font-black text-slate-950">{title}</summary>
                  <div className="mt-5 text-lg leading-8 text-slate-700">
                    <p>{first}</p>
                    <p className="mt-4">{second}</p>
                  </div>
                </details>
              ))}
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 text-5xl font-black leading-tight text-slate-950">Follow our latest work on Instagram.</h2>
                <p className="mt-5 text-lg leading-8 text-slate-700">View recent pest prevention work, treatment updates, behind-the-scenes photos, and helpful tips from the SnapControl team.</p>
                <a href="https://www.instagram.com/snapcontroluk/" className="mt-8 inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 px-8 py-4 text-lg font-bold text-white shadow-lg hover:opacity-90">View Our Instagram</a>
              </div>
              ...
              <div className="rounded-3xl bg-blue-50 p-8 shadow-sm ring-1 ring-blue-100">
                <div className="flex min-h-72 flex-col items-center justify-center rounded-2xl bg-white p-8 text-center">
                  ...
                  <p className="mt-4 max-w-md text-lg leading-8 text-red-600 font-semibold">Warning: Instagram posts may contain images of deceased animals and pest control treatments.</p>
                  <a href="https://www.instagram.com/snapcontroluk/" className="mt-6 inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 px-6 py-3 font-bold text-white shadow-lg hover:opacity-90">Open Recent Posts</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl rounded-[2rem] bg-slate-950 p-10 text-white shadow-2xl">
            <div className="grid gap-10 lg:grid-cols-[0.7fr_1.3fr] lg:items-center">
              ...
              <div>
                ...
                <blockquote className="text-2xl font-bold leading-10 text-white">“Fantastic service from start to finish. The team arrived quickly, explained everything clearly, and completely solved our rodent issue. Highly recommend SnapControl.”</blockquote>
